...
public class MusicItemServiceImpl implements IMusicItemService
{
    ...
    public int insertMusicItem(MusicItem musicItem)
    {
        ...
        Date date=new Date();musicItem.setCreateTime(DateUtils.getNowDate());
        musicItem.setId(IdGenerate.idStr(date));
        musicItem.setCreateTime(date);
        musicItem.setUpdateTime(date);
